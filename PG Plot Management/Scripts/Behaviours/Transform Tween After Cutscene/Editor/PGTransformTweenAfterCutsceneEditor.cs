...
{
    [CustomEditor(typeof(PGTransformTweenAfterCutscene))]
    public class PGTransformTweenAfterCutsceneEditor : PGPlotBehaviourEditor
    {
        private PGTransformTweenAfterCutscene _transformTweenAfterCutscene;
        ...
        {
            _transformTweenAfterCutscene = (PGTransformTweenAfterCutscene)target;
            ...
            PGPlotControllerEditorWindow.ObjectsPopup(ref _transformTweenAfterCutscene.objectIndex, "Transform Index");
