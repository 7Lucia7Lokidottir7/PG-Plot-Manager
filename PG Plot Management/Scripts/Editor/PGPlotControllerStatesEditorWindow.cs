...
namespace PG.PlotManagement
{
    public partial class PGPlotControllerEditorWindow : EditorWindow
    {
        ...
        private bool _descriptionChapterActive;
        void OnStatesMenu(int chapter)
        {
            ...
            _descriptionChapterActive = EditorGUILayout.BeginFoldoutHeaderGroup(_descriptionChapterActive, "Description Chapter");
            EditorGUILayout.EndFoldoutHeaderGroup();
            if (_descriptionChapterActive)
            {
                plotChapter.descriptionChapter = EditorGUILayout.TextArea(plotChapter.descriptionChapter, GUILayout.MinHeight(75));
            }
            GUILayout.EndVertical();
